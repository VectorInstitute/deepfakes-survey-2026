...
All **216 references cited by the survey**, organized by the role each plays in the argument. Groups follow the paper's own tables: generation groups mirror Table 3, detection families mirror Table 4, and benchmarks mirror Table 6. Entries are ordered newest-first within a subsection, and blockquotes give the assumption note the survey attaches to that group.
...
### Platform scale and forensic context
...
### Full-body puppetry and attribute editing
...
### Distribution I: Platform Upload and Forensic Transformation
...
### Distribution II: Algorithmic Propagation and Cross-Platform Reposting
...
### Platform Governance and Remediation
...
### Audio–visual and multimodal benchmarks
...
### Fully synthetic and real-world multimodal benchmarks
